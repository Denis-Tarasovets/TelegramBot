...
import static com.example.tgbot.service.FinanceService.*;
...
public class BotService extends TelegramLongPollingBot {
    ...
    public void onUpdateReceived(Update update) {
        ...
        try {
            ...
            log.error("Возникла проблема при обработке команды от пользователя", e);
        }
    }
    ...
    public void sendNotificationToAllActiveChats(String message, Set<Long> chatIds) {
        for (Long id : chatIds) {
            ...
            try {
                ...
                log.error("Возникла проблема при отправке сообщений пользователям", e);
            }
        }
    }
